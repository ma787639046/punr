...
class TrainerWithLogs(Trainer):
    ...
    def _load_from_checkpoint(self, resume_from_checkpoint, model=None):
        ...
        if not os.path.isfile(os.path.join(resume_from_checkpoint, "pytorch_model.bin")) and not os.path.isfile(
            os.path.join(resume_from_checkpoint, "pytorch_model.bin.index.json")
        ):
